...
<html lang="en">
    <head>
        ...
        <style>
            .img  {
            background-image: url("assets/img/pexels-fox.jpg");
            }
        </style>
    </head>
    ...
    <body class="bg-gradient-primary img">
		<nav class="navbar navbar-expand-lg navbar-dark bg-white shadow-lg pb-3 pt-3 font-weight-bold">
            <div class="container">
                <a class="navbar-brand text-primary" style="font-weight: 900;" href="login.php"> <i class="fa fa-database mr-2 rotate-n-15"></i> APLIKASI PENILAIAN KINERJA TENAGA MAGANG</a>
            </div>
        </nav>
